...
#include <stonefish_msgs/SonarSettings.h>
#include <stonefish_msgs/SonarSettings2.h>
#include <stonefish_msgs/Respawn.h>
...
namespace sf
{
	...
	public:
		...
		bool RespawnRobot(stonefish_msgs::Respawn::Request& req, stonefish_msgs::Respawn::Response& res);
	...
	public:
		FLSService(FLS* fls);
		bool operator()(stonefish_msgs::SonarSettings::Request& req, stonefish_msgs::SonarSettings::Response& res);
	...
	public:
		...
		bool operator()(stonefish_msgs::SonarSettings2::Request& req, stonefish_msgs::SonarSettings2::Response& res);
