...
class HybridController4DOFNode(Node):
    ...
    def _setup_parameters(self):
        ...
        self.declare_parameter('velocity_mode.Kp', [40.0, 40.0, 50.0, 4.0])
        self.declare_parameter('velocity_mode.Kd', [0.0, 20.0, 20.0, 1.0])
        self.declare_parameter('velocity_mode.Ki', [20.0, 20.0, 25.0, 2.0])
        self.declare_parameter('velocity_mode.Kb', [0.8, 0.8, 0.8, 0.8])
        self.declare_parameter('velocity_mode.max_force', 55.0)
        self.declare_parameter('velocity_mode.max_torque', 13.7)
        self.declare_parameter('velocity_mode.integral_safety_factor', 0.5)
        self.declare_parameter('position_mode.Kp', [45.0, 45.0, 55.0, 3.0])
        self.declare_parameter('position_mode.Kd', [40.0, 40.0, 50.0, 1.5])
        self.declare_parameter('position_mode.Ki', [5.0, 5.0, 10.0, 0.5])
        self.declare_parameter('position_mode.Kb', [0.8, 0.8, 0.8, 0.8])
        self.declare_parameter('position_mode.max_force', 55.0)
        self.declare_parameter('position_mode.max_torque', 13.7)
        ...
        self.declare_parameter('cascade.inner_loop.Kp', [70.0, 62.0, 64.0, 4.0])
        self.declare_parameter('cascade.inner_loop.Ki', [35.0, 31.0, 32.0, 2.0])
