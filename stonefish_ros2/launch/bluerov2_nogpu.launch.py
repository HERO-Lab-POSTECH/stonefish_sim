...
# Copyright 2025
#
# BlueROV2 Simulation Launch File (No GPU)
#
# This launch file starts:
# - Stonefish simulator with BlueROV2 scenario (headless mode)
# - Thruster manager (optional)
#
# Usage:
#   # Scenario only
#   ros2 launch stonefish_ros2 bluerov2_nogpu.launch.py start_thruster_manager:=false
#
#   # Scenario + Thruster Manager (default)
#   ros2 launch stonefish_ros2 bluerov2_nogpu.launch.py
...
def generate_launch_description():
    """Generate launch description for BlueROV2 simulation (No GPU)."""
