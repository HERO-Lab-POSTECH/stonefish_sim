...
namespace sf
{
    ...
    public:
        ...
        void FLSService(const stonefish_msgs::srv::SonarSettings::Request::SharedPtr req,
                        stonefish_msgs::srv::SonarSettings::Response::SharedPtr res, FLS* fls);
        void SSSService(const stonefish_msgs::srv::SonarSettings::Request::SharedPtr req,
                        stonefish_msgs::srv::SonarSettings::Response::SharedPtr res, SSS* sss);
        void MSISService(const stonefish_msgs::srv::SonarSettings2::Request::SharedPtr req,
